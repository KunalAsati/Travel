...
<div id="templatemo_container">
	<div id="templatemo_menu">
    	<ul>
            ...
            <li><a href="userlog.jsp" class="current">Customer Login</a></li>
        	...
        	<div class="section_w560">
              ...
              <form action="regaction.jsp" name="ff"  method="get" onsubmit="return check()">
                    ...
                    <div style="margin-left: 3px;">  
                        <input type="submit" value="Register" style="background-color: green; width: 121px; height: 30px; border: 4px; font-weight: bold;">&nbsp;&nbsp;&nbsp;
                    </form>
                    <input type="reset" value="Clear" style="background-color: red; height: 30px; width: 121px; border: 4px; font-weight: bold;"></div>
                                    <br>
