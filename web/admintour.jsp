...
<div id="templatemo_container">
	<div id="templatemo_menu">
    	<ul>
            ...
            <li><a href="#" class="current">Tour Details</a></li>
    ...
    <div id="templatemo_content" style="">
    	
        
        
            <div class="section_w560">
                    <h3>USER TOUR PACKAGE DETAILS..!</h3><BR>
				          <table border="2" style=" alignment-adjust: central; width: 100%;">
                ...
                <tr style="color: #fff; background-color: #000; alignment-adjust:auto; font-family: fantasy; font-size: 18px;">
                   ...
                   <td align="center"><font size="3">PAYMENT</font></td>
...
<%               
    ...
    //userid, str, end, intr, dot, dy, nop, status_, tcost, key_
        String  u=null,st=null,en=null,intr=null,dot=null,dy=null,nop=null,sta=null,toc=null,key=null,pref=null,payment=null,budget = null;
...
budget = rs1.getString("budget");
       ...
       <td align="center"><input type="text"  name="totoalcost" value="<%=toc%>" style="width: 80px; background: red; color: #fff;"/></td>
       <td align="center"><input type="submit" value="Go"></td> </form>
       <%
       if(!payment.equals("PAID"))
       {
       %>
       <td align="center" style="color: red;"> <%=payment%></td>
       <%
       }else{
       %>
       <td align="center" style="color: green;"> <%=payment%></td>
       <%
       }
       %>
