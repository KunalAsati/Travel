    ...
    <div id="templatemo_content">
        ...
        <div id="main_column">
        	...
        	<div class="section_w560">
                ...
                <p style="text-align: justify">Recent years have witnessed an increased interest in recommender systems. Despite significant progress in this field,
...
by considering tourist relationships, the TRAST model can be used as an effective assessment for travel group formation.</p>
