...
$sql = "UPDATE searchlog SET AdminRemark=:remark WHERE  SearchId=:iid";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="50">
      ...
      <td colspan="2" ">  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
            ...
            <tbody>
<?php 
$sql = "SELECT * from searchlog where SearchId=:iid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':iid',$iid, PDO::PARAM_STR);
$query->execute();
...
?>
    ...
    <tr>
      ...
      <td  class="fontkink"> <input type="submit" name="submit10"  value="update"   size="40" style="cursor: pointer;" /></td>
    </tr> 
    <?php } else { ?>
     <tr>
